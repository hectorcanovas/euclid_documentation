...
To reduce the examples verbosity, reduce the complexity of this document, and avoid redundancy: 
...
* Informative messages (e.g., about the status of the request) generated by the methods in the examples have been suppressed.

* Whenever possible, the documentation points to the `Astroquery.Gaia package <https://astroquery.readthedocs.io/en/latest/gaia/gaia.html>`_ that shares a similar architecture and methods with this module.
