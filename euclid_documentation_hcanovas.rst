...
In addition to catalogues that can be queried via ADQL_, the Euclid Archive also host the Euclid products: the FITS files that contain the different types or products (images, spectra, catalogues) generated by this mission. A popular Euclid
