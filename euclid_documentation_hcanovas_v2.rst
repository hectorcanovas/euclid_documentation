...
**Step 2:** The get_product_ method is used to downloads the fits file(s) listed in the "file_name" field included in the table returned in the previous step. The method returns the local path where the product(s) is saved.
