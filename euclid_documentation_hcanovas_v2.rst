...
In addition to catalogues that can be queried via ADQL_, the Euclid Archive also host the FITS files that contain the images and spectra generated by this mission. The instructions below show how to download the Euclid image of a given object, proceeding in a two-step fashion.
...
and their sky coverage (in its "fov" field) is queried. Please note:
